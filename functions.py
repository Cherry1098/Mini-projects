...
# -->in python, function is a block of organized, resuable code that performs a specific task or set of task.
# -->function allow you to break down your code into smaller modular pieces and making it more reable , maintainable and reusable.
...
#     print(my_list[3:6])                # [40, 50, 60]
#     print(my_list[-4:-7:-1])            #[50, 40, 30]
# list_1()

'''# way1:'''
# def details():
#     user_name = "sandeep"         #here user_name is variable. and sandeep is value.
...
# -->parameters receive values from arugments.
# -->syntax:
# def multiply(x,y):          # here parameter count = arguments count.
#     print(x*y)
#     # return x*y
# multiply(3,4)
...
# def my_func(x,y):
#     print(x+y)          #here before return so it prints.
#     return(x-y)         #only once return is used in one function, once the return is used, we cannot excute any statments.
...
# sub(2,4)
# sub(2,3)
# --> in form filling. if user did not fill with data. in that place none is placed.
...
# *argu(syntax)--->result will be in tuple format.
# here * means all
# def details(*a):
#     print(a)
# details("vasu","charishma","kumar")


'''keyword arguemnts'''
# -->keyword arguments are passed to function with a keyword and value, allowing for more explicit parameter passing.
# def sample(**a):
#     print(a)
# sample(vasu=2344,charishma=5372)            #o/p will be dict format.

'''variables'''#-->two types:
# 1.local variables-->present inside the function(this variable is declared only to particular one function)
# 2.global variables-->present outside the function(a variable declared outside of all functions and accessibale throughtout the program, including inside functions)
...
#     print(name)
#     print(dept)
#     print(name*2)           # local variables can perform operations only insde the function.
# greet()
...
# def credit(amount):
#     print(amount)
#     print(balance*3)          #here the value is taken from global variable
# credit(500)
# credit(balance)
...
# balance = 1000
# def credit(amount=0):
#     global balance          # here we have to use "global" to perform below operations.
#     balance += amount    
...
# -->collections of function--modules.(evry python file is module)
...
# def expo(a,b):
#     print(a**b)  
# add(5,5)            #here if any mistake happend in one of the function, we can check to correspodning function only. it wont disturb to other functions.
# sub(4,6)    
# mul(3,4)
# expo(2,3)
...
# import conditional
# conditional.age       # modulename.funcname()
...
'''# 2.built_in'''
# import from some other module, but they are in built-in in python.
# -->here are few module: # to operate particular module right click on module name select go to definition
'1.math'
# -->provides mathematical functions like trigonometric, logarithmic, exponential functions and more.
# from math import *          #here calling all functions present if math module.
# print(sqrt(16))        #squareroot
# print(pi)               # no need to use modulename. as we are import all from the module.
...
# print(floor(2.9))           # results as round up a number to the nearest smallest integer.
# print(radians(115))             # Convert angle from degrees to radians.
# print(factorial(5))             # 5!=120
'2.random' #--> to generate pseudo numbers.
# from random import *
...
'task19:'       # avg functions:        #    """Returns the average of a list of numbers."""
# def average(numbers):
#     if not numbers:
